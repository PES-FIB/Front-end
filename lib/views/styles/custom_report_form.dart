...
class CustomReportEventForm extends StatefulWidget {
  final List<String> dropdownValues;
  final Event event;

  CustomReportEventForm({
    required this.dropdownValues,
    required this.event,
  });

  @override
  CustomReportEventFormState createState() => CustomReportEventFormState();
}

class CustomReportEventFormState extends State<CustomReportEventForm> {
  String? selectedValue;
  final reportComment = TextEditingController();
  @override
  Widget build(BuildContext context) {
    final EventsController _eventsController = EventsController(context);
    return 
    AlertDialog(
      content: Column(
        mainAxisAlignment: MainAxisAlignment.center,
